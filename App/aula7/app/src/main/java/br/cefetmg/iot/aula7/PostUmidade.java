...
public class PostUmidade extends AsyncTask<Integer,String,String> {
    URL url;
    JSONObject postData;
    String retorno;
    TextView textView_response;

    public PostUmidade(Map<String, String> postData, TextView textView_response) {
        if (postData != null) {
            this.postData = new JSONObject(postData);
            this.textView_response = textView_response;
        }
        try {
            this.url = new URL("http://35.199.85.54:3000/umidade");
